<template>
    <v-app id="inspire">
        <v-app-bar app dark>
            <div class="logo">
                    <img src="@/assets/logo-fantasy-rabbit-white.png" alt="" width="120" height="50" @click="$router.push('/home')">
            </div>

            <!-- icon para menu mobile -->
            <div class="btn-mobile">
                <img src="@/assets/isotipo-white-fantasy.png" alt="" width="40"  @click="$router.push('/home')">
                    ...
                    <template v-slot:activator="{ on: menu, attrs }">
                        <v-tooltip bottom>
                            <template v-slot:activator="{ on: tooltip }">
                                <span>{{ user }} </span>
                                <v-btn class="mx-2" fab dark small color="white" v-bind="attrs"
                                    v-on="{ ...tooltip, ...menu }">
        ...
        <!-- <div class="cinti">
            <p class="mt-5">¡Pide hoy y te lo llevamos hoy! Envío discreto siempre</p> 
        </div> -->

        <v-main class="mt-3 grey lighten-4">
            <v-container>
                <slot />
            </v-container>
